    ...
    <Box sx={{ display: 'flex', flexDirection: 'column', height: '100vh' }}>
      ...
      <Box sx={{ flex: 1, overflowY: 'auto', p: 3 }}>
        <Container maxWidth="md">
          ...
          <Typography variant="body2" paragraph>
            Users with the role <b>User</b> can read or update only those
            documents that are <b>not marked as confidential</b>.
          </Typography>
          ...
          <Typography variant="body2" paragraph>
            Users with the role <b>User</b> can log in only until <b>15:30</b>.
            After this time, login attempts are denied. This rule does not apply
            to other roles.
          </Typography>
